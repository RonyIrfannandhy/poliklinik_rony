...
<div class="table-responsive my-4">
    <table class="table table-responsive" id="myTable">
        ...
        <tbody>
            ...
            $result = mysqli_query(
                $mysqli,
                "SELECT * FROM obat ORDER BY nama_obat DESC"
            );
            $no = 1;
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <a class="btn btn-success rounded-pill px-3" href="index.php?page=obat&id=<?php echo $data['id'] ?>">Ubah
                        </a>
                        <a class="btn btn-danger rounded-pill px-3" href="index.php?page=obat&id=<?php echo $data['id'] ?>&aksi=hapus">Hapus
                        </a>
                    </td>
                </tr>
            <?php
